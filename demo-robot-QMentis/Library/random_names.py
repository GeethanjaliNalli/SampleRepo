...
FirstNames    = './Library/Names/FirstNames.txt'
MiddleNames   = './Library/Names/MiddleNames.txt'
LastNames     = './Library/Names/LastNames.txt'
CountyNames   = './Library/Names/CountyNames.txt'
PlaceNames    = './Library/Names/PlaceNames.txt'
StateNames    = './Library/Names/StateNames.txt'
CountryNames  = './Library/Names/CountryNames.txt'
CompanyNames  = './Library/Names/CompanyNames.txt'
